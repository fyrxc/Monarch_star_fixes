modded class CharacterCreationMenu extends UIScriptedMenu
{
	...
	override Widget Init()
	{
		...
		layoutRoot = GetGame().GetWorkspace().CreateWidgets( "CUT_Mainmenu/gui/layouts/new_ui/character_creation/pc/cui.character_creation.layout" );
		...
		CUT_MainmenuSceneLoader.ShowPlayerForCharacterMenu();
