...
class UIColor
{
	...
	static int twitter() 			  { return ARGB(255, 255, 255, 255); };
	...
	static int tiktok()               { return ARGB(255, 0, 242, 234); };
	static int instagram()            { return ARGB(255, 225, 48, 108); };
	
	// Custom Colors (Use to add your own branding colors)
	static int CUI2Teal()             { return ARGB(0, 40, 255, 255); };
	static int CUI2Blue()             { return ARGB(0, 40, 255, 255); };
...
class colorScheme 
{
	...
	static int BrandColor() 		  { return UIColor.Violet(); };
	static int AccentColor()  		  { return UIColor.Violet(); };
